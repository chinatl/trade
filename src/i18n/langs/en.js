...
const en = {
	...
	"other": {
		"工作日工作时间": "Working hours ",
		"节假日工作时间": " Holiday working hours ",
		"联系QQ": " Contact QQ ",
		"联系电话": " Contact number ",
		"联系微博": " Contact micro-blog ",
		"QQ群": " QQ group ",
		"联系微信": " Contact WeChat ",
		"暂无内容！": " There is no content for it. ",
		"自选": " Self selection ",
		"价格输入转换": " Price input conversion ",
		"冻结": " Frozen ",
		"币种介绍": " Currency introduction ",
		"类型": " type ",
		"折算金额": " Converted amount ",
		"总数量/未成交数": " Total number / undone ",
